...
class buildingState: public State{
    public:
        ...
        {
                char chose;
                cout<<"\nBat dau them hinh nhe !";
                cout<<"\n-------------------------------------------------------------------------------------------------------------";
                // graphState->chose = graphState->menuLuaChon();
                cout<<"\n1. Tao hinh\n2. Doc File\n3. Exit";
                cout<<"\n-------------------------------------------------------------------------------------------------------------";
                cout<<"\nLua chon: ";cin>>chose;
                cout<<"\n-------------------------------------------------------------------------------------------------------------";
...
class haveShapeState: public State{
    public:
        haveShapeState(graph *gr)
        {
            graphState = gr;
        }
        void releaseKey()
...
class haveSandEState: public State{
    public:
        haveSandEState(graph *gr)
        {
            graphState = gr;
        }
        void releaseKey()
...
void graph::checkState()
{
    ...
    {
        currentState = new haveShapeState(this);
    }
    else if(chose == '3')
    {
        currentState = new haveSandEState(this);
    }
    else if(chose == '0')
    {
        currentState = new endState(this);
    }
    currentState->releaseKey();
}
void graph::menu()
{
        ...
        if(List.size()!=0)
        {
            cout<<"\n2. Thuc hien cong viec vs list Hinh";
        }
        if(List.size() >= 2)
        {
            cout<<"\n3. Thuc hien cac cong viec vs list Edge";
        }
        cout<<"\n0. Exit";
        cout<<"\nLua chon: ";cin>>chose;
        cout<<"\n-------------------------------------------------------------------------------------------------------------";
        if(chose == '1'||chose == '2'||chose == '3'||chose == '0')
        {
            checkState();
        }
}
